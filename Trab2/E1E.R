#e) Utilizando o método de Gauss-Seidel, realize dez iterações, marque os valores em um gráfico igual ao elaborado na letra a) e apresente-os em uma tabela.
